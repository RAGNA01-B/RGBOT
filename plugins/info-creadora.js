...
lugar = official[0][0] == String(contact[0]) ? 'ArmaBot' : official[1][0] == String(contact[0]) ? 'RagnaBot' : official[2][0] == String(contact[0]) ? 'RagnaBot' : official[3][0] == String(contact[0]) ? 'RagnaBot' : country === '' ? lenguajeGB.smsContacto7() : country
